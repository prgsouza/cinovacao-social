        ...
        <Card className="bg-[#88957d] text-white">
          <CardContent className="p-6">
            ...
            <p className="text-sm opacity-90 mt-2">
              Mais alunos que semana passada
            </p>
          </CardContent>
        </Card>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      className="bg-[#d09c91] hover:bg-[#7f6e62] text-white"
                    >
                      Visualizar
                    </Button>
                    <Button
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {todayActivity.responsible}
                </p>
              </div>
              <div>
                <Label className="font-medium">Vagas</Label>
                <p className="text-sm text-gray-600">
                  {todayActivity.spots} vagas disponíveis
                </p>
              </div>
              <div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Badge
                    variant={student.canGoAlone ? "default" : "secondary"}
                    className="mt-1"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {selectedStudent.canGoAlone ? "Sim" : "Não"}
                  </p>
                </div>
                <div>
                  <Label className="font-medium">Responsável</Label>
      ...
      case "women":
        return (
          <div className="text-center py-12">
            <h1 className="text-3xl font-bold text-[#7f6e62] mb-4">
              Módulo Mulheres
            </h1>
            ...
            <SidebarContent>
              ...
              {sidebarItems.map((group) => (
                <SidebarGroup key={group.title}>
                  <SidebarGroupLabel className="text-[#7f6e62] font-semibold">
                    {group.title}
                  </SidebarGroupLabel>
                  <SidebarGroupContent>
                    <SidebarMenu>
